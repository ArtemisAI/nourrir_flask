...
# --- n8n Configuration ---
# Default n8n webhook for the HR assistant. Can be overridden via env var.
# It is the *chat* endpoint generated by the n8n "When chat message received" trigger.
N8N_WEBHOOK_URL = os.getenv(
    "N8N_WEBHOOK_URL",
    "https://n8n.artemis-ai.ca:8443/webhook/3856912a-4b68-441b-ba1a-beb4e64356e0/chat"
)

# Some deployments might expose the same webhook on standard HTTPS port (443).
